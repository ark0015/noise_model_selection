...
#num_cusp = 2
cusp_idxs = [4.,2.,'vary']
cusp_signs = ['positive','positive','vary']
"""
dm_annual = False
chrom_gp = True
chrom_gp_kernel = 'nondiag'
...
round_number = f'6_{red_psd}_psd_no_chrom_gp_periodic_dm_nondiag_k_2_positive_cusps_4_2_idx_vs_3_cusps_4_2_vary_cusp_idx'
writeHotChains = True
